...
public class UserRemoveServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = UsersManager.getInstance().remove(id);
	...
	private void displayView(HttpServletRequest request, HttpServletResponse response, User user) throws IOException{
		...
		out.println("<html><body><h1>User "+ user.getName() + " " + user.getSurname() +" removed</h1></br><a href='list'>Retour à la liste</a></body></html>");
	}
